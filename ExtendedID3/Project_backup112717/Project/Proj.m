...
[Data_rotated,theta,pure]=Rotation(Data,Data(:,1));
...
[Clusters,LenClusters,Table]=TableWrite(Clusters,LenClusters,Table,Data,j,pure,Index1,Index2,idx1,idx2,X1min,X2min, bX1, bX2,theta);
...
while (Allpure)
    ...
    C=Clusters(j,1:temp);
    %Rotate the data
    [Data_rotated,theta,pure]=Rotation(Data,C);
